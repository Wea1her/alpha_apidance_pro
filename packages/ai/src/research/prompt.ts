...
export function buildResearchReportPrompt(input: ResearchPromptInput): { system: string; user: string } {
  ...
  const user = [
    ...
    '7. 标签：输出 3-8 个具体中文标签，并覆盖生态/赛道、产品形态和阶段特征。若项目核心是 Launchpad/发射台/代币发射平台，必须单独标注 Launchpad，不要把它写成 DeFi；只有核心产品是交易、借贷或收益协议时才使用 DeFi 标签。',
    '',
    '请完成 L2 六赛道深挖：',
    tracks,
    '',
